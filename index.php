<?php 
    ...
    $router->addRoutes(array(
        ...
        array( 'GET', '/deudas/login/', 'login'),
        array( 'GET', '/deudas/register/', 'register'),

        // Panel Actions
        
        array( 'GET', '/deudas/', 'main'),
        array( 'GET', '/deudas/users/', 'users'),
    ));
...
<html lang="es">
    ...
    <body>
        ...
        <?php 
            if ($match['target'] == 'login' || $match['target'] == 'register' || !$match) include $view;
            else { ?>
